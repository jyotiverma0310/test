package com.matellio.store.config;
...
@Configuration
@EnableMongoRepositories("com.matellio.store.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.matellio.store.config.dbmigrations");
