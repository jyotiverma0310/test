...
/**
 * REST controller for managing {@link com.matellio.store.domain.AboutUs}.
 */
@RestController
@RequestMapping("/api")
public class AboutUsResource {
    ...
    public ResponseEntity<AboutUsDTO> updateAboutUs(@RequestBody AboutUsDTO aboutUsDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, aboutUsDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<AboutUsDTO> getAboutUs(@PathVariable String id) {
    ...
    public ResponseEntity<Void> deleteAboutUs(@PathVariable String id) {
