...
/**
 * REST controller for managing {@link com.matellio.store.domain.UserLocation}.
 */
@RestController
@RequestMapping("/api")
public class UserLocationResource {
    ...
    public ResponseEntity<UserLocationDTO> updateUserLocation(@RequestBody UserLocationDTO userLocationDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, userLocationDTO.getId()))
            .body(result);
    }
