...
/**
 * REST controller for managing {@link com.matellio.store.domain.Wallet}.
 */
@RestController
@RequestMapping("/api")
public class WalletResource {
    ...
    public ResponseEntity<WalletDTO> updateWallet(@RequestBody WalletDTO walletDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, walletDTO.getId()))
            .body(result);
    }
