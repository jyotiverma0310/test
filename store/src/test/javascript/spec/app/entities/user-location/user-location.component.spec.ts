...
import { UserLocationComponent } from 'app/entities/user-location/user-location.component';
...
describe('Component Tests', () => {
  describe('UserLocation Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userLocations && comp.userLocations[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
