...
import { WholesalerComponent } from 'app/entities/wholesaler/wholesaler.component';
...
describe('Component Tests', () => {
  describe('Wholesaler Management Component', () => {
    let comp: WholesalerComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(WholesalerComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.wholesalers && comp.wholesalers[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
